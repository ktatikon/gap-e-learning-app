...
export default function ContentManagement() {
  ...
  const contentList = [
    { id: 1, title: 'GMP Fundamentals v2.1', type: 'Video', category: 'GMP', uploaded: '2024-01-15' },
    { id: 2, title: '21 CFR Part 11 Guide', type: 'PDF', category: 'Regulatory', uploaded: '2024-01-14' },
    { id: 3, title: 'CAPA Training Module', type: 'SCORM', category: 'Quality', uploaded: '2024-01-13' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="gxp-card">
        ...
        <p className="text-muted-foreground">Upload and manage training content.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={handleUpload} className="w-full gxp-button-primary">
              Upload Content
            </Button>
          </CardContent>
        </Card>
